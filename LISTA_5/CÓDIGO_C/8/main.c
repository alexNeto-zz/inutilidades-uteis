...
/*Faça um programa que processe 10 pedidos. Para cada pedido o programa
deve ler o código do representante (1 a 10), o total de itens e o valor total do
pedido. O programa deve informar:
...
o total de comissões que a companhia pagou aos seus
representantes.*/
...
int main()
{
	...
	for(i = 0; i < 10; i++)
	{
		...
		if (totalItens < 20){
			...
			printf(" %dº pedido feito pelo\
representante código %d:\n\
